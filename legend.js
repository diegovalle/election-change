...
var legendPRI = ["PRI increased its share of the vote",
                 "PRI lost votes, PRD gained the most votes",
                 "PRI lost votes, PAN gained the most votes"];
var legendPRD = ["PRD lost votes, PRI gained the most votes",
		 "PRD increased its share of the vote",
                 "PRD lost votes, PAN gained the most votes"];
var legendPAN = ["PAN lost votes, PRI gained the most votes",
                 "PAN lost votes, PRD gained the most votes",
		 "PAN increased its share of the vote"];
var legendBiggestLoser = ["PRI lost the most votes",
                   "PRD lost the most votes",
                   "PAN lost the most votes"];
var legendBiggestWinner = ["PRI gained the most votes",
                    "PRD gained the most votes",
                    "PAN gained the most votes"];
